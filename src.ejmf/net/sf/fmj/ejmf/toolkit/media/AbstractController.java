        ...
        Controller
{
    ...
    private final Object threadqueueMutex = new Object();

    private Vector<Control> controls = new Vector<>();
    private Vector<ControllerListener> listeners = new Vector<>();
    ...
    public AbstractController()
    {
        ...
        setAndLogEngineState(currentState);
    }
    ...
    public final synchronized void deallocate()
    {
        ...
        if (doDeallocate())
        {
            ...
            {
                state = setAndLogEngineState(Unrealized);
            } else
            {
                state = setAndLogEngineState(Realized);
            }
     ...
     * can trackback the source of a configuration error. So we simply call this
     * method to log the state change and cause.
     *
     * NOTE: This method is also present in BasicController and the two
     * should be updated together.
     *
     * @param newState The state the engine is changing to
     * @return The state the engine is changing to
     */
    protected synchronized int setAndLogEngineState(int newState)
    {
        ...
        Log.comment("Change of engine state " + previousState + " to " + newState +
    ...
    protected synchronized void setState(int state)
    {
        ...
        currentState = setAndLogEngineState(state);
    }
