        ...
        SenderReport, ReceiverReport
{
    ...
    public Feedback getSenderFeedback()
    {
        ...
        Vector<? extends Feedback> feedback = null;
    ...
    /* Stop receiving packets on this stream.
     */
    public void stopReceiving()
    {
        // Reset newrecvstream so that if we start receiving packets from this
        // SSRC again then we'll relink it to a media device for playback.
        this.newrecvstream = true;
    }
