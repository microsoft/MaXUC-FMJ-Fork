...
public class SimpleGraphBuilder
{
     ...
     */
    public static Codec findCodec(Format in, Format out, Format selectedIn[],
            Format selectedOut[])
    {
        Vector<String> cnames = PlugInManager.getPlugInList(in, out,
                PlugInManager.CODEC);
        if (cnames == null)
        {
    ...
    {
        Vector<String> names = PlugInManager.getPlugInList(in, null,
     ...
     */
    public static GraphNode getPlugInNode(String name, int type,
            Hashtable<String, GraphNode> plugIns)
    {
        GraphNode gn = null;
     ...
     */
    public static Format matches(Format outs[], Format ins[], PlugIn up,
            PlugIn down)
    {
        Format fmt;
        if (outs == null)
     ...
     * @return a matching format.
     */
    public static Format matches(Format out, Format ins[], PlugIn up,
            PlugIn down)
    {
    ...
    public static Format matches(Format outs[], Format in, PlugIn up,
            PlugIn down)
    {
    ...
    GraphNode doBuildGraph(Vector<GraphNode> candidates)
    {
        ...
        if (node.input == null && !(node.plugin instanceof Codec))
        {
            // shouldn't happen!
