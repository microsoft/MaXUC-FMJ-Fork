...
public class InputStreamReader extends InputStream
{
    ...
    {
        private final ProducerConsumerQueue<Buffer> emptyQueue;
        private final ProducerConsumerQueue<Object> fullQueue;
        private final InputStream is;
        private final int bufferSize;

        public ReaderThread(final ProducerConsumerQueue<Buffer> emptyQueue,
                final ProducerConsumerQueue<Object> fullQueue, final InputStream is,
    ...
    private final ProducerConsumerQueue<Buffer> emptyQueue = new ProducerConsumerQueue<>();

    private final ProducerConsumerQueue<Object> fullQueue = new ProducerConsumerQueue<>();
