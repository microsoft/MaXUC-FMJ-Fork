...
{
    static Vector<RTPTimeBase> timeBases = new Vector<RTPTimeBase>();
    ...
    public static RTPTimeBase find(RTPTimeReporter rtptimereporter, String s)
    {
        ...
        synchronized (timeBases)
        {
            ...
            {
                Log.comment("Created RTP time base for the session\n");
    ...
    Vector<RTPTimeReporter> reporters;
    ...
    {
        master = null;
        reporters = new Vector<RTPTimeReporter>();
        origin = 0L;
        offset = 0L;
