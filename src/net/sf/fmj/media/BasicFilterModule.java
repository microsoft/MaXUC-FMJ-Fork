        ...
        if (codec != null)
        {
            try
            {
                ...
                if (VERBOSE_CONTROL)
                {
                    ...
                    Control[] controls = (Control[]) codec.getControls();
                    for (Control c : controls)
                    {
                        controlFrame.add(c.getControlComponent());
                    }
                    controlFrame.pack();
                    controlFrame.show();
                }
    ...
    public void process()
    {
        ...
        do
        {
            ...
            try
            {
                ...
                // Call to H264 encoder comes here
            ...
            if (curFramesBehind > 0f && outputBuffer.isDiscard())
            {
                ...
                // downstream just so the downstream module can
