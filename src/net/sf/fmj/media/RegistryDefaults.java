...
public class RegistryDefaults
{
    ...
    public static void registerContentPrefixList(int flags)
    {
        ...
        final Vector<String> v = PackageManager.getContentPrefixList();
    ...
    public static void registerProtocolPrefixList(int flags)
    {
        ...
        final Vector<String> v = PackageManager.getProtocolPrefixList();
    ...
    private static List<String> removePluginsFromList(int flags, List<String> v)
    {
        final List<String> result = new ArrayList<String>();
        for (final String className : v)
        {
    ...
    public static void unRegisterPlugins(int flags)
    {
        ...
        for (int type : types)
        {
            final Vector<String> v = PlugInManager.getPlugInList(null, null, type);
            final List<String> vRemove = removePluginsFromList(flags, v);
