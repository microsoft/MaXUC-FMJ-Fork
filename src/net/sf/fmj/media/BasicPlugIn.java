...
public abstract class BasicPlugIn implements PlugIn
{
            ...
            throws ClassNotFoundException
    {
         ...
         * CLASSPATH, you have to load it using the system class loader.
         */
        try
        {
         ...
         * you have to load it using the context class loader.
         */
        try
        {
            // TODO May need to invoke RuntimePermission("getClassLoader") privilege.
    ...
    {
        Vector<String> cnames = PlugInManager.getPlugInList(null, null, type);
