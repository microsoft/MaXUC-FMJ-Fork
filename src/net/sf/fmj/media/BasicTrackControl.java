...
public class BasicTrackControl implements javax.media.control.TrackControl
{
    ...
    static final String connectErr = "Cannot set a PlugIn after reaching the configured state.";
    ...
    protected Vector<BasicModule> modules = new Vector<>(7);
