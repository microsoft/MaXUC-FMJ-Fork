...
public class FramePositioningAdapter implements FramePositioningControl,
        Reparentable
{
    public static Track getPrimaryTrack(Track tracks[])
    {
        Track primary = null;
        Format f;
        ...
        if (primary != null
                && primary.mapTimeToFrame(new Time(0)) != FramePositioningControl.FRAME_UNKNOWN)
            return primary;
        else
            return null;
    }
    ...
    {
        return primary.mapFrameToTime(frameNumber);
    }
    ...
    {
        return primary.mapTimeToFrame(mediaTime);
    }
    ...
    public int skip(int framesToSkip)
    {
        ...
        {
            int currentFrame = primary.mapTimeToFrame(player.getMediaTime());
            if (currentFrame != 0
