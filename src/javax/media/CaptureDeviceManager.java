 ...
 * "https://java.sun.com/products/java-media/jmf/2.1.1/apidocs/javax/media/CaptureDeviceManager.html"
...
public class CaptureDeviceManager
{
    ...
    public static Vector<CaptureDeviceInfo> getDeviceList(Format format)
    {
        if (!init())
            return null;
        return (Vector<CaptureDeviceInfo>) callImpl(getDeviceListMethod, new Object[] { format });
    }
