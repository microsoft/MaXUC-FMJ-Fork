 ...
 * "https://java.sun.com/products/java-media/jmf/2.1.1/apidocs/javax/media/PlugInManager.html"
...
public class PlugInManager
{
    ...
    public static Vector<String> getPlugInList(Format input, Format output, int type)
    {
        if (!init())
            return null;
        return (Vector<String>) callImpl(getPlugInListMethod, new Object[] { input,
    ...
    public static void setPlugInList(Vector<String> plugins, int type)
    {
        if (!init())
            return;
