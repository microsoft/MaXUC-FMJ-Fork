 ...
 * "https://java.sun.com/products/java-media/jmf/2.1.1/apidocs/javax/media/PackageManager.html"
...
public class PackageManager
{
    ...
    public static Vector<String> getContentPrefixList()
    {
        if (!init())
            return null;
        return (Vector<String>) callImpl(getContentPrefixListMethod, new Object[] {});
    }

    @SuppressWarnings("unchecked")
    public static Vector<String> getProtocolPrefixList()
    {
        if (!init())
            return null;
        return (Vector<String>) callImpl(getProtocolPrefixListMethod, new Object[] {});
    }
    ...
    public static void setContentPrefixList(Vector<String> list)
    {
        if (!init())
            return;
    ...
    public static void setProtocolPrefixList(Vector<String> list)
    {
        if (!init())
            return;
