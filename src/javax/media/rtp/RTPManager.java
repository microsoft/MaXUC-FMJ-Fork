 ...
 * "https://java.sun.com/products/java-media/jmf/2.1.1/apidocs/javax/media/rtp/RTPManager.html"
...
public abstract class RTPManager implements Controls
{
    ...
    public abstract Vector<Participant> getActiveParticipants();

    public abstract Vector<Participant> getAllParticipants();
    ...
    public abstract Vector<Participant> getPassiveParticipants();

    public abstract Vector<RTPStream> getReceiveStreams();

    public abstract Vector<Participant> getRemoteParticipants();

    public abstract Vector<? extends RTPStream> getSendStreams();
