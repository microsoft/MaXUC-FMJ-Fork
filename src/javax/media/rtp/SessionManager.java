 ...
 * "https://java.sun.com/products/java-media/jmf/2.1.1/apidocs/javax/media/rtp/SessionManager.html"
...
public interface SessionManager extends Controls
{
    ...
    public java.util.Vector<Participant> getActiveParticipants();

    public java.util.Vector<Participant> getAllParticipants();
    ...
    public java.util.Vector<Participant> getPassiveParticipants();

    public java.util.Vector<SessionAddress> getPeers();

    public java.util.Vector<RTPStream> getReceiveStreams();

    public java.util.Vector<Participant> getRemoteParticipants();

    public java.util.Vector<? extends SendStream> getSendStreams();
